...
<div class="page-wrap">
    ...
    <div class="panel-card">
        ...
        <div class="panel-header">
            <div>
                <h3 class="panel-title">Gestión de Categorías</h3>
                <p class="panel-subtitle">Categorías de tu local</p>
            </div>
...
<!-- MODAL -->
<div class="modal-pro" id="modalCategoria">
    <div class="modal-card">

        <div class="modal-head">
            <h4 id="tituloModal">Nueva Categoría</h4>
...
async function cargarCategorias(){
    ...
    document.getElementById("kpiActivas").innerText = data.filter(c=>c.activo==1).length;
    document.getElementById("kpiInactivas").innerText = data.filter(c=>c.activo==0).length;
    ...
    data.forEach((c,i)=>{
        ...
        tbody.innerHTML += `
            <tr>
                <td>${i+1}</td>
                <td class="local-name">${c.nombre_categoria}</td>
                <td>
                    <span class="badge-state ${c.activo==1 ? 'badge-active':'badge-inactive'}">
                ...
                <td>
                    <div class="actions">
                        <button class="btn-action" onclick='editar(${JSON.stringify(c)})'>Editar</button>
                        <button class="btn-action btn-danger" onclick="eliminar(${c.id_categoria})">Desactivar</button>
                    </div>
                </td>
            </tr>
        `;
...
function editar(c){
    ...
    document.getElementById("nombre_categoria").value = c.nombre_categoria;
